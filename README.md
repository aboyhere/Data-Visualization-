...
phonepe is an transaction application more than 2000 + crores transaction has done in various places in india this project will 
...
# Step 2:
# Data extraction:
Clone the Github using scripting to fetch the data from the Phonepe pulse Github repository and store it in a suitable format such as JSON or CSV. Use the below syntax to clone the phonepe github repository into your local drive.
